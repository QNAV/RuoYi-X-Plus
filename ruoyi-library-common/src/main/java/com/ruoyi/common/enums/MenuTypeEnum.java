...
public enum MenuTypeEnum implements BaseEnum {
    ...
    // code对应的枚举map
    public static Map<String, MenuTypeEnum> CMAPS = new HashMap<>();
    // info对应的枚举map
    public static Map<String, MenuTypeEnum> IMAPS = new HashMap<>();
     ...
     * @return
     */
    public static MenuTypeEnum getEnumByCode(String code) {
     ...
     * @return
     */
    public static MenuTypeEnum getEnumByInfo(String info) {
    ...
    public static String getCode(Object obj) {
        ...
        MenuTypeEnum e = (MenuTypeEnum) obj;
        return e.getCode();
    }
