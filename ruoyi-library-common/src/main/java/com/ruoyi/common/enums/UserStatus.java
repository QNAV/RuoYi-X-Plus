...
public enum UserStatus implements BaseEnum {
    ...
    // code对应的枚举map
    public static Map<String, UserStatus> CMAPS = new HashMap<>();
    // info对应的枚举map
    public static Map<String, UserStatus> IMAPS = new HashMap<>();
     ...
     * @return
     */
    public static UserStatus getEnumByCode(String code) {
     ...
     * @return
     */
    public static UserStatus getEnumByInfo(String info) {
