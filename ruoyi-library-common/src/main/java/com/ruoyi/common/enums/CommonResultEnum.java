...
public enum CommonResultEnum implements BaseEnum {
    ...
    // code对应的枚举map
    public static Map<String, CommonResultEnum> CMAPS = new HashMap<>();
    // info对应的枚举map
    public static Map<String, CommonResultEnum> IMAPS = new HashMap<>();

    static {
        // 静态初始化
        for (CommonResultEnum e: values()){
     ...
     * @return
     */
    public static CommonResultEnum getEnumByCode(String code) {
     ...
     * @return
     */
    public static CommonResultEnum getEnumByInfo(String info) {
    ...
    public static String getCode(Object obj) {
        ...
        CommonResultEnum e = (CommonResultEnum) obj;
        return e.getCode();
    }
