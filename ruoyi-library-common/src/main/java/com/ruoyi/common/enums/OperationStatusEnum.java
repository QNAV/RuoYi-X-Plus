...
public enum OperationStatusEnum implements BaseEnum {
    ...
    // code对应的枚举map
    public static Map<String, OperationStatusEnum> CMAPS = new HashMap<>();
    // info对应的枚举map
    public static Map<String, OperationStatusEnum> IMAPS = new HashMap<>();
     ...
     * @return
     */
    public static OperationStatusEnum getEnumByCode(String code) {
     ...
     * @return
     */
    public static OperationStatusEnum getEnumByInfo(String info) {
    ...
    public static String getCode(Object obj) {
        ...
        OperationStatusEnum e = (OperationStatusEnum) obj;
        return e.getCode();
    }
