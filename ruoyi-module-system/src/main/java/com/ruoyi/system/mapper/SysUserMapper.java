...
public interface SysUserMapper extends BaseMapperPlus<SysUserMapper, SysUser, SysUser> {
    ...
    Page<SysUserVo> selectPageUserVoList(@Param("page") Page<SysUser> page, @Param(Constants.WRAPPER) Wrapper<SysUser> queryWrapper);
    ...
    Page<SysUserVo> selectAllocatedVoList(@Param("page") Page<SysUser> page, @Param(Constants.WRAPPER) Wrapper<SysUser> queryWrapper);
    ...
    Page<SysUserVo> selectUnallocatedVoList(@Param("page") Page<SysUser> page, @Param(Constants.WRAPPER) Wrapper<SysUser> queryWrapper);
