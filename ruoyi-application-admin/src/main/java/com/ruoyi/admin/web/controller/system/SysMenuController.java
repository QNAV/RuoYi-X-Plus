...
public class SysMenuController extends AdminBaseController {
    ...
    public R<Void> add(@Validated @RequestBody SysMenuAddBo menuBo) {
        ...
        if (CommonYesOrNoEnum.NO.equals(menuService.checkMenuNameUnique(menu))) {
            return R.fail("新增菜单'" + menu.getMenuName() + "'失败，菜单名称已存在");
        } else if (CommonYesOrNoEnum.YES.equals(menu.getIsFrame()) && !StringUtils.ishttp(menu.getPath())) {
