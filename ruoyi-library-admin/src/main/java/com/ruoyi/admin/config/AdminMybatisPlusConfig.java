...
public class AdminMybatisPlusConfig {
     ...
     * 数据权限拦截器
     */
    public AdminDataPermissionInterceptor dataPermissionInterceptor() {
        return new AdminDataPermissionInterceptor();
    }
    ...
    public MetaObjectHandler metaObjectHandler() {
        return new AdminCreateAndUpdateMetaObjectHandler();
    }
